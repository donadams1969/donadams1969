...
IGNORE_DIRS = {".git", ".github", "__pycache__", "node_modules", "venv", "env", "typechain-types", "artifacts", "cache"}
IGNORE_FILES = {
    "README.md",
    ".gitignore",
    "LICENSE",
    ...
    "requirements.txt",
    # System Integrity Protection: Critical Configuration Files
    "package.json",
    "hardhat.config.mjs",
    "next.config.mjs",
    "tsconfig.json",
    ...
    "next-env.d.ts",
    "pnpm-lock.yaml",
    # Next.js App Router Structure (Renaming these breaks routing)
    "page.tsx",
    "layout.tsx",
    "globals.css",
    "not-found.tsx",
